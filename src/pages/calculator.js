            ...
            <div className="card">
              <div className="card-body">
                ...
                <div className="date-selector">
                  ...
                  <label for="year-before">Between August 1, 2020 and July 31, 2021</label>
                  <input type="radio" id="last-year" name="increase-date" value="last-year" onChange={(e) => this.handleIncreaseDateChange(e)} />
                  <label for="last-year">Between August 1, 2021 and July 31, 2022</label>
                  ...
                  <label for="this-year">Between August 1, 2022 and July 31, 2023</label>
                </div>
                <br />
